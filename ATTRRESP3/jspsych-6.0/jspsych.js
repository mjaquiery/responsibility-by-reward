...
//added 12 jan 18
  ...
  module.getLastLastTrialData = function() {
			if(allData.length == 0){
				return {};
			}
    ...
    module.getLastLastLastTrialData = function() {
  			if(allData.length == 0){
  				return {};
  			}
  			return allData[allData.length-3];
  		};

      module.getLastLastLastLastTrialData = function() {
          if(allData.length == 0){
            return {};
          }
          return allData[allData.length-4];
        };

        module.getL5TrialData = function() {
            if(allData.length == 0){
              return {};
            }
            return allData[allData.length-5];
          };

          module.getL6TrialData = function() {
              if(allData.length == 0){
                return {};
              }
              return allData[allData.length-6];
            };

            module.getL7TrialData = function() {
                if(allData.length == 0){
                  return {};
                }
                return allData[allData.length-7];
              };
