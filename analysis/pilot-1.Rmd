...
The key analysis is an ANOVA exploring the effects of who gets the trial outcome and what that outcome is (and also whether the participant votes with the majority). 
The dependent variable is the participant's rating of their own responsibility for the decision.
...
There was no significant main effect of whether or not the Vote status put the _Participant in Majority_).
...
The increase in ratings of responsibility for trials on which participant was the _Outcome owner_ was equivalent whether or not the Vote status had the _Participant in Majority_.
Finally, there was a three-way interaction: the difference in responsibility for _Reward_ vs _No reward_ trials according to whether the participant was the _Outcome owner_ differed according to the Vote status ($F$(1, 53) = 7.64, $p$ = .001, $\eta_p^2$ = .003).
