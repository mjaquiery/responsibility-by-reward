...
We explored this statistically with a 2x2x2 ANOVA 
...
These approaches agree on the presence of main effects for _Outcome valence_, and _Outcome recipient_, but while the Bayesian ANOVA shows evidence of an effect of whether the rated player _Is the participant_, this effect is non-significant.

For two-way interactions, the approaches agree on the presence of an interaction between _Outcome valence_ and _Outcome recipient_. 
The Bayesian test was inconclusive for the interaction between _Outcome valence_ and whether the rated player _Is the participant_, as well as for the interaction between _Outcome recipient_ and whether the rated player _Is the participant_.
Both of these interactions were significant on the frequentist analysis. 
...
Bayesian stats in this complex setup are difficult to do correctly such that they give reliable and defensible results, and the results are consistent across similar statistical analyses. 
