 ...
 *
 Added by Marwa 12/01/2018: to display 2 images at the same time, using stimulus2
 **/

jsPsych.plugins["image-button-response2"] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    // display stimulus
  //  var html = '<img src="'+trial.stimulus+''+trial.stimulus2+'" id="jspsych-image-button-response-stimulus"></img>';
    var html = '<img src="'+trial.stimulus+'" id="jspsych-image-button-response-stimulus"></img> <img src="'+trial.stimulus2+'" id="jspsych-image-button-response-stimulus"></img>';
    //display buttons
    var buttons = [];
